...
- Current candidate: `v2.2.144-pp-drain-proof`; engine `1.1.6`. Final local bundle: 11,481,709 bytes, SHA-256 `f2fe442bbe215b2bed1375a4f35c244295c7ac89884568a5464f2691a4b158b0`. No v144 deployment is claimed.
- Full project gate: 156 fast files and 12 offline/mock DB files passed. The declared cross-format accuracy harness completed 4,624 battles with zero state failures, validator errors, validator warnings or repeatability failures. The battle audit completed 4,500 matrix battles without JavaScript errors. Live database readback/advisors were read-only; production was not mutated.
...
| Regulations and sources | [Watcher/staging safeguards](docs/release/REGULATION_WATCH_2026-08-30.md): 35 watcher tests, 39 staging checks, 10 legacy approval checks; post-M-B date gap fails closed | Capture and approve the post-M-B regulation. M-A/M-B remain unverified. Hosted activation, evidence keys, complete eligibility and atomic human approval/publication remain open |
