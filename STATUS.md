...
- Current candidate: `v2.2.143-regulation-db-truth`; engine `1.1.5`. Final local bundle: 11,479,875 bytes, SHA-256 `dec3c18e6331d8a1620b8401fc7622ed630ad0f99c871233073a73b9886ec85d`. No v143 deployment is claimed.
- Full project gate: 155 fast files and 12 offline/mock DB files passed after regenerating an unchanged tournament-catalog blob. The declared cross-format accuracy harness completed 4,624 battles with zero state failures, validator errors, validator warnings or repeatability failures. Live database readback/advisors were read-only; production was not mutated.
