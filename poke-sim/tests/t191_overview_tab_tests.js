...
T('6. Overview renders through a reusable function for future growth', () => {
  ...
  inc(ui, 'Which lead should I bring?');
  inc(ui, 'Which four should I select?');
  inc(ui, 'Why did I lose?');
  inc(ui, 'Is this team safe to trust?');
  ...
  inc(ui, 'A 60-second path from question to answer');
  ...
  inc(ui, 'function csRenderHomeQuestionCards');
  inc(ui, 'function csRenderHomePlayerOutcomes');
  inc(ui, 'function csRenderHomeQuickPlan');
