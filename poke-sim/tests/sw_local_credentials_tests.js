...
T('4. service worker cache is bumped for current source-registry release', () => {
  ...
  truthy(sw.includes("RELEASE_MANIFEST.service_worker_cache || 'champions-sim-v190-home-graffiti-title'"), 'CACHE_NAME should derive from release manifest fallback');
