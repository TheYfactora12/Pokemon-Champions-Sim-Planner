...
T('1. manifest exposes canonical build and cache identity', () => {
  ...
  truthy(manifest.build_id === 'v2.2.88-qa-artifact-claim-boundary', 'build id mismatch');
  truthy(manifest.service_worker_cache === 'champions-sim-v2-2-88-qa-artifact-claim-boundary', 'cache id mismatch');
