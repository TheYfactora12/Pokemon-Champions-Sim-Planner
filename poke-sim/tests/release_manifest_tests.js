...
T('1. manifest exposes canonical build and cache identity', () => {
  ...
  truthy(manifest.build_id === 'v2.2.53-home-roadmap-split', 'build id mismatch');
  truthy(manifest.service_worker_cache === 'champions-sim-v185-home-roadmap-split', 'cache id mismatch');
