...
T('1. manifest exposes canonical build and cache identity', () => {
  ...
  truthy(manifest.build_id === 'v2.2.54-home-news-carousel', 'build id mismatch');
  truthy(manifest.service_worker_cache === 'champions-sim-v186-home-news-carousel', 'cache id mismatch');
