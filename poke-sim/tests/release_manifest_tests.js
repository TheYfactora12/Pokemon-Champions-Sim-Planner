...
T('1. manifest exposes canonical build and cache identity', () => {
  ...
  truthy(manifest.build_id === 'v2.2.95-replay-logic-audit', 'build id mismatch');
  truthy(manifest.service_worker_cache === 'champions-sim-v2-2-95-replay-logic-audit', 'cache id mismatch');
