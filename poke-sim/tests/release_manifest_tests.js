...
T('1. manifest exposes canonical build and cache identity', () => {
  ...
  truthy(manifest.build_id === 'v2.2.77-battle-sensei-scenario-queue', 'build id mismatch');
  truthy(manifest.service_worker_cache === 'champions-sim-v209-battle-sensei-scenario-queue', 'cache id mismatch');
