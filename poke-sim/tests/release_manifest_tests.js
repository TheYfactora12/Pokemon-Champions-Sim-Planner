...
T('1. manifest exposes canonical build and cache identity', () => {
  ...
  truthy(manifest.build_id === 'v2.2.65-team-lab-admin-reset', 'build id mismatch');
  truthy(manifest.service_worker_cache === 'champions-sim-v197-team-lab-admin-reset', 'cache id mismatch');
