...
T('1. manifest exposes canonical build and cache identity', () => {
  ...
  truthy(manifest.build_id === 'v2.2.156-coaching-template-evidence', 'build id mismatch');
  truthy(manifest.service_worker_cache === 'champions-sim-v2-2-156-coaching-template-evidence', 'cache id mismatch');
