...
T('1. manifest exposes canonical build and cache identity', () => {
  ...
  truthy(manifest.build_id === 'v2.2.74-mega-runtime-guard-tests', 'build id mismatch');
  truthy(manifest.service_worker_cache === 'champions-sim-v206-mega-runtime-guard-tests', 'cache id mismatch');
