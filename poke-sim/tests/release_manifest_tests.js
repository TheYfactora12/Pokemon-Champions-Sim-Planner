...
T('1. manifest exposes canonical build and cache identity', () => {
  ...
  truthy(manifest.build_id === 'v2.2.69-lock-priority-proof', 'build id mismatch');
  truthy(manifest.service_worker_cache === 'champions-sim-v201-lock-priority-proof', 'cache id mismatch');
