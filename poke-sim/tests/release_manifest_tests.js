...
T('1. manifest exposes canonical build and cache identity', () => {
  ...
  truthy(manifest.build_id === 'v2.2.62-battle-labs-clean-hero', 'build id mismatch');
  truthy(manifest.service_worker_cache === 'champions-sim-v194-battle-labs-clean-hero', 'cache id mismatch');
