...
T('1. manifest exposes canonical build and cache identity', () => {
  ...
  truthy(manifest.build_id === 'v2.2.71-team-lab-mapping-promotion', 'build id mismatch');
  truthy(manifest.service_worker_cache === 'champions-sim-v203-team-lab-mapping-promotion', 'cache id mismatch');
