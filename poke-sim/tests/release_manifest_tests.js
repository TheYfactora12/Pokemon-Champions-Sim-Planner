...
T('1. manifest exposes canonical build and cache identity', () => {
  ...
  truthy(manifest.build_id === 'v2.2.144-pp-drain-proof', 'build id mismatch');
  truthy(manifest.service_worker_cache === 'champions-sim-v2-2-144-pp-drain-proof', 'cache id mismatch');
