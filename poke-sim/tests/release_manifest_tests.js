...
T('1. manifest exposes canonical build and cache identity', () => {
  ...
  truthy(manifest.build_id === 'v2.2.39-app-shell-security-split', 'build id mismatch');
  truthy(manifest.service_worker_cache === 'champions-sim-v171-app-shell-security-split', 'cache id mismatch');
