...
T('1. manifest exposes canonical build and cache identity', () => {
  ...
  truthy(manifest.build_id === 'v2.2.70-team-lab-db-preview', 'build id mismatch');
  truthy(manifest.service_worker_cache === 'champions-sim-v202-team-lab-db-preview', 'cache id mismatch');
