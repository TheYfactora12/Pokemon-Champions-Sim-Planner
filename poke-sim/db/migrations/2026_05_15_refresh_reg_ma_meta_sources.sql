-- Migration: 2026_05_15_refresh_reg_ma_meta_sources
-- Purpose: refresh the public Champions Reg M-A prior snapshot after verifying
-- the Smogon stats index now includes Champions files directly.
--
...
WHERE prior_id = 'reg_ma_meta_2026_05_15_public_sources';
...
INSERT INTO prior_snapshots (
  ...
  'reg_ma_meta_2026_05_15_public_sources',
  'public_web_pokestats_showdowntier_smogon',
  'gen9championsvgc2026regma',
  NULL,
  DATE '2026-05-01',
  'public web sources checked 2026-05-15',
  '{
    ...
    "source_audit": {
      "smogon_stats": {
        ...
        "champions_reg_ma_file_seen": true,
        "champions_reg_ma_files_seen": [
          "gen9championsvgc2026regma-0.txt",
          "gen9championsvgc2026regma-1500.txt",
          "gen9championsvgc2026regma-1630.txt",
          "gen9championsvgc2026regma-1760.txt"
        ],
        "note": "Official Smogon stats index includes Champions Reg M-A files directly; this snapshot records the file path confirmation and still treats usage data as priors only."
      },
      "smogon_forum": {
      ...
      "showdowntier": {
        ...
        "last_updated_at": "2026-05-15 01:04 UTC",
        "note": "Battle-performance source; usage/win rates differ from Pokestats because methodology differs. Live format pages were current on 2026-05-15, so this stays a performance cross-check only."
      }
    },
    "pokestats_all_top": [
